...
class Rectangle(Forme):
    def __init__(self, canevas, x, y, l, h, couleur):
        ...
        self._item = canevas.create_rectangle(x, y, x+l, y+h, fill=couleur, state="hidden",width = 0)
        self.__l = l
        self.__h = h
...
class Ellipse(Forme):
    def __init__(self, canevas, x, y, rx, ry, couleur):
        Forme.__init__(self, canevas, x, y)
        self._item = canevas.create_oval(x-rx, y-ry, x+rx, y+ry, fill=couleur, state="hidden",width=0)
        self.__rx = rx
        self.__ry = ry
